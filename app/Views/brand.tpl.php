<h1>Marque ayant l'id : <?= $viewData['brandId'] ?></h1>
...
<section class="products-grid">
    <div class="container-fluid">
      ...
      <div class="row">
        <!-- product-->
        <?php foreach($viewData['productsByBrand'] as $product) : ?>
        <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          ...
          <div class="product-action-buttons">
            ...
            <a href="<?= $router->generate('route_product_by_id', ['productId' => $product->getId()]) ?>" class="btn btn-dark btn-buy"><i class="fa-search fa"></i><span class="btn-buy-label ml-2">Voir</span></a>
          </div>
          <div class="py-2">
